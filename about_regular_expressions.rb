...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Any search containing * should never fail, but might return an empty string.  If the * charater is escaped, the test might fail.
  end
  ...
  #
  # Why?
  # Because they grab everything that matches the test case.
